...
CREATE TABLE material (
    ...
    container_weight float,  -- ��Ӧԭ��Ͱ��Ĭ��Ƥ��
    unit varchar(8),
    enable tinyint
);
...
CREATE TABLE workorder (
    ...
    eid int NOT NULL constraint fk_workorder_eid foreign key references equipment(id), -- ��Ӧһ��Ͱ�����壩
    code varchar(32) NOT NULL unique,
    sequence smallint,
    quantity float,
    unit varchar(8),
...
INSERT INTO [material] (code, name, type, container, container_weight, unit, enable) VALUES ('s-FJ01', 's-����Ũ��Һ', 'Һ����', 'Ͱ', 0, 'kg', 1);
INSERT INTO [material] (code, name, type, container, container_weight, unit, enable) VALUES ('s-XJ01', 's-�㾫A��', '��ĩ��', '��', 0.005, 'kg', 1);
INSERT INTO [material] (code, name, type, container, container_weight, unit, enable) VALUES ('s-XL01', 's-����', '������', '��', 0.005, 'kg', 1);
INSERT INTO [material] (code, name, type, container, container_weight, unit, enable) VALUES ('s-CY01', 's-��ҶŨ��Һ', 'Һ����', 'Ͱ', 0, 'kg', 1);
INSERT INTO [material] (code, name, type, container, container_weight, unit, enable) VALUES ('s-CZ01', 's-��֭Ũ��Һ', 'Һ����', 'Ͱ', 0, 'kg', 1);
-- ----------------------------------------------------------------------------
-- ԭ�Ͻ����ϼ�
